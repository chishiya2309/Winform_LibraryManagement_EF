...
namespace Winform_LibraryManagement_EF6
{
    public partial class FormAddMember : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                // Tạo đối tượng thành viên mới từ thông tin form
        ...
        private bool ValidateInputs()
        {
            ...
            {
                MessageBox.Show("Số điện thoại đã được đăng ký cho thành viên khác!", "Lỗi",
                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtSoDienThoai.Focus();
                return false;
            }
            ...
            {
                MessageBox.Show("Email đã được đăng ký cho thành viên khác!", "Lỗi",
                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtEmail.Focus();
                return false;
            }
